...
const FeaturedTopics = () => {
  return (
    <section className="bg-base-200 py-10 lg:py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {categories.map((item, idx) => (
          <div
            key={idx}
            className="flex items-center gap-3 bg-white p-4 rounded-lg border border-base-300 text-left transition"
            style={{
