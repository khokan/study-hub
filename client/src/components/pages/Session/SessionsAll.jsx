    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="flex justify-end mb-6">
        <div className="flex items-center gap-2">
          <span className="text-sm text-secondary-gray4 whitespace-nowrap">
            Sort by:
          </span>
          <select
            value={sortOrder}
          ...
          {filteredSessions
            .sort((a, b) => {
              switch (sortOrder) {
                ...
                case "date-asc":
                  return (
                    new Date(a.registrationStartDate) -
                    new Date(b.registrationStartDate)
                  );
                case "date-desc":
                  return (
                    new Date(b.registrationStartDate) -
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-3">
                      ...
                      <p className="text-xs text-secondary-gray1 badge badge-outline flex flex-wrap items-center gap-1">
                        Reg:
